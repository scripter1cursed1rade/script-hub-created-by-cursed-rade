...
local Window = Library.CreateLib("Script Hub Created Created By Cursed_Rade FE", "RJTheme3")

local Tab = Window:NewTab("Script Hub")

local Section = Tab:NewSection("Scripts")

Section:NewButton("Walk On Walls Script", "NP", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/zXk4Rq2r"))()
end)

local Section = Tab:NewSection("what")

Section:NewButton("Snake Script", "NP", function()
	loadstring(game:HttpGet(('https://pastefy.ga/tWBTcE4R/raw'),true))()
end)

local Section = Tab:NewSection("hi")

Section:NewButton("Gelatek Hub Script", "NP", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Gelatekussy/GelatekHub/main/Main.lua"))()
end)

local Section = Tab:NewSection("hi")

Section:NewButton("Pendulum Hub Script", "NP", function()
...
Section:NewButton("Ultimate Trolling Gui V3 Script", "NP", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/killermaster9999mega/UTG-V3/main/FE%20UTG%20V3.txt"))()
end)

local Section = Tab:NewSection("hi")

Section:NewButton("Free Fe Bundles Script", "NP", function()
	loadstring(game:HttpGet("https://gitlab.com/Tsuniox/lua-stuff/-/raw/master/R15GUI.lua"))()
end)

local Section = Tab:NewSection("hi")

Section:NewButton("Fucking Slasher Script [you need a thing for the script to work link to the thing: https://web.roblox.com/catalog/7548993875/Slasher]", "NP", function()
	loadstring(game:HttpGet(('https://raw.githubusercontent.com/Toasty8i/slasher/main/slasher.lua'),true))()
end)

local Section = Tab:NewSection("hi")

Section:NewButton("Funny Fe Character Script", "NP", function()
